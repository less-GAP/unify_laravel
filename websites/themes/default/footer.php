...
<!--Vendor js-->
<script src="<?= theme_file('src/vendors/hc-sticky/dist/hc-sticky.js') ?>"></script>
<script src="<?= theme_file('src/vendors/glightbox/dist/js/glightbox.min.js') ?>"></script>
<script src="<?= theme_file('src/vendors/@splidejs/splide/dist/js/splide.min.js') ?>"></script>
<script src="<?= theme_file('src/vendors/@splidejs/splide-extension-video/dist/js/splide-extension-video.min.js') ?>"></script>

<!-- Start development js -->
<script src="<?= theme_file('src/js/theme.js') ?>"></script>
<!-- End development js -->
