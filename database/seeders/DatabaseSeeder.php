...
//        DB::statement('SET FOREIGN_KEY_CHECKS=0');
        ...
        Role::create(['name' => 'Super Admin', 'team_id' => null]);
        ...
        $role = Role::create(['name' => 'Writer', 'team_id' => null]);
        Permission::findOrCreate('posts.*');
        Permission::findOrCreate('patients.*');
        Permission::findOrCreate('files.*');
        $role->givePermissionTo('posts.*');
        $role->givePermissionTo('patients.*');
        $user->assignRole('Writer');
        $user->givePermissionTo('files.*');
