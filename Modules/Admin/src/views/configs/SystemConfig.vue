...
<template>
  <a-form autocomplete="off" v-bind="formConfig" @finish="submit">
    ...
    <a-form-item label="Auto create order after days" name="auto_create_order_days" required>
      <a-input-number v-model:value="formState.auto_create_order_days" placeholder="days..."></a-input-number>
    </a-form-item>
    <a-form-item>
      <a-space>
