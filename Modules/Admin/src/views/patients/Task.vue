...
const completeTask = function (id, status) {
  updateTaskApi(id, {
    is_completed: status ? status : 1,
    task_process: status ? 2 : 0, // need review
  ...
  >
    ...
    >
      <div class="p-3 bg-gray-200">
        ...
        <a-button
          class="!inline-flex items-center justify-center md:!hidden !w-8 !h-8 !p-0"
          type="link"
          @click="closeDetail"
        >
          <template #icon>
      ...
      <div class="px-4 mt-5 overflow-y-auto" style="height: calc(100% - 60px)">
        <div class="flex flex-wrap -mx-4">
          ...
          <a-Divider
            ...
            plain
            >List tasks of {{ formState.full_name }}
          </a-Divider>
            ...
            <div class="flex items-center font-medium">
              <div class="flex flex-wrap items-center flex-grow text-gray-900">
                  ...
                  <div class="listNeedToDo">
                    <div v-for="ntd in needToDoList" :key="ntd.value">
                      ...
                      >
                        ...
                        >
                          <svg
                            class="hidden w-4 h-4 fill-black"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20"
                          >
                            <path
                ...
                <div class="w-full py-4">
                  <a-button
                    v-if="$auth.hasPermission('task.assign')"
                    class="mt-4"
                    type="primary"
                    @click="addTask"
                  >
                        ...
                        <template v-if="task.deleted === 0">
                          <td width="150px">
                            <div class="flex flex-wrap justify-center">
                              <a-button
                                v-if="
                                  (auth.hasPermission('task.assign') ||
                              ...
                              >
                                <BaseIcon
                                  :path="mdiCheckCircle"
                                  class="text-current hover:text-green-500"
                                ></BaseIcon>
                              </a-button>
                              <a-button
                              ...
                              >
                                <BaseIcon
                                  :path="mdiPencil"
                                  class="text-current hover:text-blue-500"
                                ></BaseIcon>
                              </a-button>
                              <a-button
                              ...
                              >
                                <BaseIcon
                                  ...
                                  class="text-current hover:text-orange-500"
                                ></BaseIcon>
                              </a-button>
                            </div>
                          </td>
                          ...
                          <td>
                            <div class="flex">
                              <div
                                v-for="id_assignee in assigneesArray(
                                  task.assignees
                                )"
                                :key="id_assignee"
                                class="item-assignee"
                              >
                                <a-avatar-group>
                                  <a-tooltip
                                    :title="nameAssignee(id_assignee, true)"
                                    placement="top"
                                  >
                                    <a-avatar
                                      style="background-color: #87d068"
                                      >{{ nameAssignee(id_assignee) }}</a-avatar
                                    >
                                  </a-tooltip>
                                </a-avatar-group>
                              </div>
    ...
    >
      ...
      >
        ...
        <div class="flex flex-wrap -mx-2">
          ...
          <div class="w-full px-2">
            <a-form-item label="Due date">
              <a-date-picker
                v-model:value="formTaskState.deadline_at"
                class="w-full"
        ...
        <a-form-item label="Assignees" required>
          <a-select
            v-model:value="formTaskState.assignees"
            :options="listUserAssignees"
            mode="multiple"
          >
          </a-select>
        </a-form-item>
        <a-form-item label="Description">
          <a-textarea
            v-model:value="formTaskState.description"
            :rows="4"
          ></a-textarea>
        </a-form-item>
      </a-form>
