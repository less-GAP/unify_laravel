...
<template>
  <a-drawer body-style="padding:0" :closable="false"
    style="position:relative;display:flex;flex-direction:column;height:100vh;" @close="closeDetail" :open="true"
    width="90vw">
          ...
          <a-row style="height:calc(100vh - 100px);" class="p-5" :gutter="20">
            <a-col :span="8">
              ...
              <a-form-item class="w-full" name="email_cc" label="Mail cc">
                <a-select v-model:value="formState.email_cc" mode="tags" style="width: 100%"
                  :token-separators="[',']"></a-select>

              </a-form-item>
              <a-form-item class="w-full" name="email_bcc" label="Mail bcc">
                <a-select v-model:value="formState.email_bcc" mode="tags" style="width: 100%"
                  :token-separators="[',']"></a-select>
            ...
            <a-col :span="16">
              <a-form-item class="w-full" name="email_title" label="Mail Content" :rules="[{ required: true }]">
                <jodit-editor v-if="!loading" style="height: 80vh" v-model="formState.email_content" :config="{
                  buttons,
                  height: '70vh',
