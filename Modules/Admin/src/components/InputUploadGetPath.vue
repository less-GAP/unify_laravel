<template>
  <slot></slot>
  <div class="relative inline-flex overflow-hidden border border-gray-400 rounded-lg">
    <a-image
    class="bg-white min-w-[200px] min-h-[200px] max-w-[200px] max-h-[200px] object-cover"
    :placeholder=true
    :src="$url(value)"
