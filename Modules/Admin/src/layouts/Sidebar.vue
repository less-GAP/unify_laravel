...
<template>
  <aside
    :class="$appState.showMenu ? 'w-[' + $style.theme.sidebarWidth + '] lg:flex' : 'lg:w-[' + $style.theme.sidebarCollapsedWidth + '] collapsed lg:left-0 -left-[' + $style.theme.sidebarWidth + ']'"
    id="sidebar"
    class="top-0 left-0 z-20 flex flex-col flex-shrink-0 h-full overflow-auto font-normal duration-75 bg-white transition-width"
    aria-label="Sidebar">
    <div
      ...
      <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
        <div class="flex-1 px-3 space-y-1 divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
          ...
          <div class="pt-2 space-y-2">
            ...
            <router-link to="/configs/general"
              class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
              <svg
      ...
      <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
        ...
        <a data-tooltip-target="tooltip-settings"
          class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
        ...
        <div
          ...
          style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(184px, 886px);">
